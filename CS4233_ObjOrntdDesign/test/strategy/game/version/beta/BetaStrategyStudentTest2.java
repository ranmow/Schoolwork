...
/**
 * Professor's test suite for BetaStrategyMaster.
 * @author gpollice
 * @version Sep 12, 2013
 */
public class BetaStrategyStudentTest2
{
	...
	public void defenderWinsStrike() throws StrategyException
	{
		...
		Piece pieceat22 = game.getPieceAt(loc22);
		assertEquals(new Piece(LIEUTENANT, RED), pieceat22);
	}
