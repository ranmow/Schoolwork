...
public class Location2D implements Location
{
	...
	/**
	 * Location2d contains the cartesian coordinates of a location.
	 * (Starts at 0,0)
	 * @param xCoordinate the x coordinate of the given location
	 * @param yCoordinate the y coordinate of the given location
	 */
